...
var quizJSON = {
    "info": {
        ...
        "level1":  "Grand Wizard. You have given up all wordly needs for the pursuit of pure knowledge. <img height=200 src='https://i.pinimg.com/736x/7f/70/3d/7f703d26330398388e94130899893a8d--fantasy-wizard-fantasy-art.jpg'/>",
        ...
        "level5":  "Troglodyte. You linger in darkness, forsaking all attempts to perservere and learn. <img height=200 src='https://vignette.wikia.nocookie.net/lotr/images/e/e1/Gollum_Render.png/revision/latest?cb=20141218075509'/>" // end, no comma here
    },
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            ...
            "a": [
                ...
                {"option": "My week with Elizabeth Taylor",      "correct": false} // no comma here
            ],
            ...
            "incorrect": "<p><span>Wrong!</span>The correct answer is Elizabeth Taylor: The Last Star.</p>" // no comma here
        },
        { // Question 2 - Multiple Choice, Multiple True Answers, Select Any
            ...
            "a": [
                ...
                {"option": "Elaine Caryn Johnson",   "correct": false} // no comma here
            ],
            ...
            "incorrect": "<p><span>That's Wrong!</span>The Answer is Caryn Elaine Johnson</p>" // no comma here
        },
        { // Question 3 - Multiple Choice, Multiple True Answers, Select All
            ...
            "a": [
                ...
                {"option": "Somalia",          "correct": false} // no comma here
            ],
        ...
        { // Question 4
            ...
            "a": [
                ...
                {"option": "Flerovium",   "correct": true} // no comma here
            ],
            "correct": "<p><span>Correct! Amazing!</span>Flerovium is a Synthetic element, and does not occur naturally on Earth.</p>",
            "incorrect": "<p><span>Wrong!</span>The correct answer is Flerovium.</p>" // no comma here
        },
        { // Question 5
            ...
            "a": [
                ...
                {"option": "Shelob",       "correct": false} // no comma here
            ],
            ...
            "incorrect": "<p><span>That's Wrong!</span>The correct answer is Ungoliant.</p>" // no comma here
        },
            { // Question 3 - Multiple Choice, Multiple True Answers, Select All
            ...
            "a": [
                ...
                {"option": "Kate Upton & Selena Gomez",          "correct": true} // no comma here
            ],
        ...
        { // Question 5
            ...
            "a": [
                ...
                {"option": "Swordfish",       "correct": false} // no comma here
            ],
